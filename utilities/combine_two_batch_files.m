function []=combine_two_batch_files(batch1_name,batch1_path,batch2_name,batch2_path,varargin)
%% Syntax
%
...
filelist_combined=[filelist1;filelist2];


selected_batchname=uiputfile([supp_inputs.disk_write_dir '*.*'],'What name do you want to give to the combined batch file?','batch_*');
spawning_func=mfilename('fullpath');
write_batch_from_filelist(filelist_combined,selected_batchname,supp_inputs.disk_write_dir,...
                                                                    'batch_inputs',inputs,...
